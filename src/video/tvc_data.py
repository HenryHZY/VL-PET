...
def resize(input_tensor, length):
    ...
    if L < length:
        ...
        # print('input_tensor, input_tensor.shape, length 21= ', input_tensor, input_tensor.shape, length)
        input_tensor = input_tensor.t()
        input_tensor = input_tensor.unsqueeze(0)
        input_tensor = F.adaptive_max_pool1d(input_tensor, length)
        input_tensor = input_tensor.squeeze(0)
        input_tensor = input_tensor.t()
        # print('input_tensor, input_tensor.shape, length 22= ', input_tensor, input_tensor.shape, length)
    return input_tensor
...
class TVCEvaluator:
    def __init__(self, data, types):
        ...
        self.evaluator = language_evaluation.CocoEvaluator(coco_types=["CIDEr"], verbose=False)
