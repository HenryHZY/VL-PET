...
lr=$7
sh=T5_bs300_Encoder_MultiheadDownAdapter_dim$2_head$3_MultiheadUpZeroInit_GatingLowRankLN_dim$4_GatingScaling$5_GatingUpZeroInit_Decoder_VPAdapter_dim$6_VPAUpZeroInit_lr$7_seed$8
...
python -m torch.distributed.launch \
    ...
    --encoder_gating_scaling_factor $5 \
    --use_encoder_gating_large_x_lowrank_up_zero_init \
    --unfreeze_encoder_layer_norms \
    --no_decoder_adapter \
    --use_decoder_enc_attn_value_parallel_adapter_down_dim \
    --decoder_enc_attn_value_parallel_adapter_down_dim $6 \
