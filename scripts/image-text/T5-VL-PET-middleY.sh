...
lr=$6
sh=T5_bs300_Encoder_MultiheadDownAdapter_dim$2_head$3_MultiheadUpZeroInit_GatingMiddle_ia3addLN_GatingScaling$4_GatingIA3ZeroInit_Decoder_VPAdapter_dim$5_VPAUpZeroInit_lr$6_seed$7
...
python -m torch.distributed.launch \
    ...
    --use_encoder_gating_middle_ia3_zero_init \
