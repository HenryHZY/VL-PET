...
sh=hyperformer_projected_task_embedding_dim${projected_task_embedding_dim}_lr${lr}_seed$2
name=${sh}_${feature}_LMhyperformer${projected_task_embedding_dim}+r8+ln_bs${batch_size}_image224_lr${lr}
