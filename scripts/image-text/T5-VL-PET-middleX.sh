...
lr=$6
sh=T5_bs300_Encoder_MultiheadDownAdapter_dim$2_head$3_MultiheadUpZeroInit_GatingMiddle_xyaddLN_GatingScaling$4_GatingUpZeroInit_Decoder_VPAdapter_dim$5_VPAUpZeroInit_lr$6_seed$7
...
python -m torch.distributed.launch \
    ...
    --use_encoder_adapter_gating_middle_xy_add \
    --use_encoder_gating_scaling \
    --encoder_gating_scaling_factor $4 \
    --use_encoder_gating_middle_up_zero_init \
